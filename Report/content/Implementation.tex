...
The topology for the differentiator was taken from \citetitle{DifferentiatorTopology} is shown by \citeauthor{DifferentiatorTopology} in figure 4.69\cite{DifferentiatorTopology}.
